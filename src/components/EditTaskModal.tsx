...
export default function EditTaskModal({
  ...
  const [selectedTag, setSelectedTag] = useState<string | undefined | null>(task.tag?._id || "");
  const [selectedAssignee, setSelectedAssignee] = useState<string | undefined | null>(
    task.assignee?._id || "",
  );
  ...
  const handleSubmit = async () => {
    ...
    const { success, error, data } = await updateTask(task._id, {
      ...
      assignee: selectedAssignee === "" ? null : selectedAssignee,
