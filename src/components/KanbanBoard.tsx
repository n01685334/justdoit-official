...
/**
 * Main kanban board component managing columns, tasks, and modal interactions.
 * Handles task creation and editing modals with column-specific context.
 * Renders scrollable horizontal layout of project columns with drag-and-drop support.
 */
