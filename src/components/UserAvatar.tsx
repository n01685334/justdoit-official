...
/**
 * User avatar component with fallback to initials display.
 * Attempts to load user profile image from API, falls back to colored initials.
 * Supports customizable sizing and styling with proper cleanup of blob URLs.
 */
