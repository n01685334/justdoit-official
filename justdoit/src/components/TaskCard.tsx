...
const categoryColors = [
  "bg-blue-900/30", "bg-green-900/30", "bg-yellow-900/30", "bg-pink-900/30", "bg-purple-900/30", 
  "bg-indigo-900/30", "bg-red-900/30", "bg-orange-900/30", "bg-teal-900/30", "bg-cyan-900/30"
];

export const userColors = [
  "bg-blue-600", "bg-green-600", "bg-yellow-600", "bg-pink-600", "bg-purple-600", 
    ...
    <>
      ...
      >
        <div className="flex justify-between items-start">
          ...
          {task.assignee && (
            <div className={`${userColors[task.assignee.colorIndex]} w-8 h-8 rounded-full flex items-center justify-center text-white font-medium`}>
